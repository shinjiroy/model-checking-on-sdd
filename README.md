...
そして、LLMエージェントを利用した開発手法として仕様駆動開発が主流となりつつあります。モデル検査を活用し、仕様駆動開発で作られる仕様書(仕様定義)の精度、品質を上げるということを目標に置いています。ここでは[Spec Kit](https://github.com/github/spec-kit)を想定しています。
